            ...
            Column(
              children: [
                ...
                const SizedBox(height: 60),
                 const Column(  
                  children: [
                    Text("Naziv", style: TextStyle( fontWeight: FontWeight.bold, fontSize: 25),), //dodati atribute za sve
                    Text("Režija"),
                    Text("Sadržaj"),
                  ],
                 ),
                 ...
                 Container(
                  height: 80,
                      ...
                      decoration:BoxDecoration(
                        color: const Color.fromARGB(255, 102, 98, 98),borderRadius: BorderRadius.circular(10),
                        ),
