...
namespace ePozoriste.Services.Migrations
{
    ...
    [Migration("20230920120621_added-row")]
            ...
            modelBuilder.Entity("ePozoriste.Services.Database.Obavijest", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ObavijestId = 1,
                            DatumKreiranja = new DateTime(2023, 9, 20, 14, 6, 20, 687, DateTimeKind.Local).AddTicks(4607),
                            KorisnikId = 1,
            ...
            modelBuilder.Entity("ePozoriste.Services.Database.Termin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            TerminId = 1,
                            CijenaKarte = 20,
                            DatumOdrzavanja = new DateTime(2023, 9, 20, 0, 0, 0, 0, DateTimeKind.Local),
                            Predpremijera = true,
                            PredstavaId = 1,
                            Premijera = false,
                            SalaId = 1,
