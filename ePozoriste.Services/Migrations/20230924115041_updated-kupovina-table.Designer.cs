...
namespace ePozoriste.Services.Migrations
{
    ...
    [Migration("20230924115041_updated-kupovina-table")]
    partial class updatedkupovinatable
    {
            ...
            modelBuilder.Entity("ePozoriste.Services.Database.Obavijest", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ObavijestId = 1,
                            DatumKreiranja = new DateTime(2023, 9, 24, 13, 50, 41, 66, DateTimeKind.Local).AddTicks(8608),
                            KorisnikId = 1,
            ...
            modelBuilder.Entity("ePozoriste.Services.Database.Termin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            TerminId = 1,
                            CijenaKarte = 20,
                            DatumOdrzavanja = new DateTime(2023, 9, 24, 0, 0, 0, 0, DateTimeKind.Local),
                            Predpremijera = true,
                            PredstavaId = 1,
                            Premijera = false,
                            SalaId = 1,
