...
namespace ePozoriste.Services.Migrations
{
    ...
    [Migration("20230817182207_promjena_naziva")]
    partial class promjena_naziva
    {
            ...
            modelBuilder.Entity("ePozoriste.Services.Database.Obavijest", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ObavijestId = 1,
                            DatumKreiranja = new DateTime(2023, 8, 17, 20, 22, 6, 785, DateTimeKind.Local).AddTicks(6404),
                            KorisnikId = 1,
            ...
            modelBuilder.Entity("ePozoriste.Services.Database.Termin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            TerminId = 1,
                            CijenaKarte = 20,
                            DatumOdrzavanja = new DateTime(2023, 8, 17, 0, 0, 0, 0, DateTimeKind.Local),
                            Predpremijera = true,
                            PredstavaId = 1,
                            Premijera = false,
                            SalaId = 1,
